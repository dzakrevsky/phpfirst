...
<body>
    <header>
        ...
        <div class="items">
            @auth
                <a class="kall1" href="{{ route('donation-history') }}">Profile</a>
                <a class="kall" href="{{ route('logout') }}">Logout</a>
            @else
                <a class="kall" href="{{ route('login') }}">Login</a>
            @endauth
        </div>
    </header>
    ...
    <div class="secHeader">
        ...
        @auth 
            <a href="{{ route('donation-history') }}"><button class="btn1">Accept Donations</button></a> 
            <a href="{{ route('donation-history') }}"><button class="btn2">Give Now</button></a> 
        @else
            <a href="{{ route('login') }}"><button class="btn1">Accept Donations</button></a>
            <a href="{{ route('login') }}"><button class="btn2">Give Now</button></a>
        @endauth
    </div>
    <main>
